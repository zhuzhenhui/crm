            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li name="courseorder"><a href="/courseorder/list.do"><i class="fa fa-circle-o"></i> 订单客户</a></li>
                    <li name="salary"><a href="/salary/list.do"><i class="fa fa-circle-o"></i> 工资管理</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
